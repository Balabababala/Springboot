...
import com.example.demo.model.dto.UserLoginSummitDto;
...
public class LoginRestController {
	...
	@PostMapping("/login")
	public ResponseEntity<ApiResponse<Void>> login(@RequestBody UserLoginSummitDto userLoginSummotDto, HttpSession session) {
	    try {
	        UserCert cert = certService.getCert(userLoginSummotDto.getUsername(), userLoginSummotDto.getPassword());
	...
	public ResponseEntity<ApiResponse<Void>> logout(HttpSession session) {
	    ...
	    System.out.println("userCert before invalidate = " + session.getAttribute("userCert"));
